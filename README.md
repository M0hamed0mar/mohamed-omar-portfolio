...
- **SEO** - Structured metadata, Open Graph, Twitter Cards, sitemap, robots.txt.
...
│ │ └── ui/ # Reusable components (Logo, ThemeToggle, ProjectCard, etc.)
...
git clone https://github.com/M0hamed0mar/portfolio.git
cd portfolio
...
npm run checkRun Astro + TypeScript diagnostics
npm run astroAccess Astro CLI directly
Image Optimization
